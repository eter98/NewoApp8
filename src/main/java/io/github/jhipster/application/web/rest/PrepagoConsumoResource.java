...
public class PrepagoConsumoResource {
    ...
    public PrepagoConsumoResource(PrepagoConsumoRepository prepagoConsumoRepository) {
    ...
    public List<PrepagoConsumo> getAllPrepagoConsumos() {
        log.debug("REST request to get all PrepagoConsumos");
        return prepagoConsumoRepository.findAll();
    }
    ...
    public ResponseEntity<PrepagoConsumo> getPrepagoConsumo(@PathVariable Long id) {
        ...
        Optional<PrepagoConsumo> prepagoConsumo = prepagoConsumoRepository.findById(id);
